...
const DataToDesign = () => {
  ...
  return(<>
    ...
    <Card mtgData={mtgCard} />

    {/* {!isLoading && (<>
      <Box sx={{ backgroundColor:'#CFCEB7', width:'clamp(250px, 85vw, 1250px)', padding:'1.5rem 1.75rem', borderRadius:'14px', margin:'auto' }}>
        <DisplayData data={mtgCard} />
